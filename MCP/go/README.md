# Identity and Access Management (IAM) API MCP Server

This MCP (Model Content Protocol) server provides access to Identity and Access Management (IAM) API API functionality through HTTP, HTTPS, and STDIO transport modes.
