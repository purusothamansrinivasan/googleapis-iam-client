...
// Import Post_V2_ParentMCPTool - included in same package
// Import Get_V2_NameMCPTool - included in same package
// Import Put_V2_NameMCPTool - included in same package
// Import Delete_V2_NameMCPTool - included in same package
// Import Get_V2_ParentMCPTool - included in same package
...
public class MCPServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Register all tools
            tools = Arrays.asList(
            Post_V2_ParentMCPTool.createPost_V2_ParentTool(config),
            Get_V2_NameMCPTool.createGet_V2_NameTool(config),
            Put_V2_NameMCPTool.createPut_V2_NameTool(config),
            Delete_V2_NameMCPTool.createDelete_V2_NameTool(config),
            Get_V2_ParentMCPTool.createGet_V2_ParentTool(config)
            );
